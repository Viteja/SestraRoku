...
export default function Kategorie2() {
  return (
    <>
      <Navbar />
      <Helmet>
        <meta charSet="utf-8" />
        <title>Sestra Pardubického kraje | Sestra v sociálních službách</title>
        <link rel="canonical" href="https://sestra.pardubickykraj.cz//sestra-v-socialnich-sluzbach" />
      </Helmet>
          ...
          <div className="row">
            <div className="kat-text">
              ...
              <p>
                ...
                , zajišťující péči prostřednictvím sociálních služeb.
              </p>
            </div>
          </div>
        </div>
